@section('seo')
<title>BloodConnect - Kebijakan Privasi</title>
...
<meta property="og:site_name" content="Kebijakan Privasi" />
...
<div class="d-flex flex-column container w-100 min-h-50px min-h-lg-50px px-9">
  <div class="mb-5 mb-lg-10">
      <h1 class="text-white lh-base fw-bold fs-5x fs-lg-3x mb-0">Kebijakan Privasi
      <br />
      </h1>
      <p class="fw-semibold text-light fs-1x fs-lg-1x">
          <span id="kt_landing_hero_text text-muted">
            Home <span class="fw-bold px-2">/</span> Kebijakan Privasi
          </span>
      </p>
  </div>
</div>
